document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateEditorFields() {
    document
      .getElementById("header-heading-container")
    ...
    if (template === "simple") {
      document
        .getElementById("about-us-text-container")
        .classList.add("hidden");
      document
        .getElementById("services-text-container")
        .classList.add("hidden");
    } else {
      document
        .getElementById("about-us-text-container")
  ...
  function updatePreview() {
    const menuItems = menuItemInputs
      .map((input) => `<li><a href="#">${input.value}</a></li>`)
      .join("");
    ...
    let previewContent = templates[template]
    ...
    livePreviewIframe.onload = function () {
      livePreviewIframe.style.height =
        livePreviewIframe.contentWindow.document.body.scrollHeight + "px";
    };
  }
